...
public class Demo {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			// 上传图片
			File file = new File("E:\\soft\\apache-tomcat-8.0.14-sgwa\\webapps\\ROOT\\temp\\exportData-20180316151715.xlsx");
			UploadResult uploadResult = MediaHelper.upload(accessToken, MediaHelper.TYPE_FILE, file);
			System.out.println(uploadResult.getMedia_id());
			log("成功上传图片", uploadResult);
			
			MessageBody.FileBody fileBody = new MessageBody.FileBody();
			fileBody.setMedia_id(uploadResult.getMedia_id());
			...
			lightAppMessageDelivery.withMessage(MessageType.IMAGE, fileBody);
